...
app.put("/updateuseraccount/:id",authenticationUser,upload.single('profilePic'),checkSchema(idValidationSchema),userCtrl.update)
...
app.post('/payment/razor/create',authenticationUser,paymentCtrl.createRazorpayOrder)
app.post('/payments/verify-razorpay',authenticationUser,paymentCtrl.verifyRazorpayPayment)
